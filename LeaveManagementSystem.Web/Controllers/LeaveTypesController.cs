...
namespace LeaveManagementSystem.Web.Controllers
{
    ...
    {
        private const string leaveTypeExistsErrorMessage = "Leave type with the same name already exists.";
        ...
        public async Task<IActionResult> Create(LeaveTypeCreateVM leaveTypeCreate)
        {
            ...
            {
                ModelState.AddModelError(nameof(leaveTypeCreate.Name), leaveTypeExistsErrorMessage);
            }
        ...
        public async Task<IActionResult> Edit(int id, LeaveTypeEditVM leaveTypeEdit)
        {
            ...
            {
                ModelState.AddModelError(nameof(leaveTypeEdit.Name), leaveTypeExistsErrorMessage);
            }
